...
### Definitions:
Dependent variable : The variable whose values you want to predict. The dependent variable must be binary or dichotomous, and should only contain data coded as 0 or 1. 

Independent variables : The independent variables are the variables which are expected to influence the dependent variable.
